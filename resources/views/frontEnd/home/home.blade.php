                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html">
                                    <img src="{{ asset($blogs->image) }}" class="card-img" alt="">
                                </a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <ul class="category-tag-list">
                                        <li class="category-tag-name">
                                            <a href="#">{{ $blogs->category->category_name }}</a>
                                        </li>
                                    </ul>
                                    <h5 class="card-title title-font"><a href="{{ route('blog.details',['slug'=>$blogs->slug]) }}">Making time for travel</a>
                                    </h5>
                                    <p class="card-text">{{ $blogs->description }}<p>
                                    <div class="author-date">
                                        <a class="author" href="#">
                                            <img src="{{ asset($blogs->author->image) }}" alt="" class="rounded-circle" />
                                            <span class="writer-name-small">{{ $blogs->author->author_name }}</span>
                                        </a>
                                        <a class="date" href="#">
                                            <span>{{ date('d F Y',strtotime($blogs->date)) }}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
